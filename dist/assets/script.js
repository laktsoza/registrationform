...
var inputForUsername = document.getElementById('username');
...
function register() {
  if (inputForEmail.value && password.value && password.value === RePassword.value && inputForUsername.value) {
    ...
    if (!users.some(function (element) {
      ...
      users.push(new User(inputForEmail.value, inputForUsername.value, password.value, (0,uuid__WEBPACK_IMPORTED_MODULE_2__.default)()));
